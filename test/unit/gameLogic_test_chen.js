describe("In Connect6", function () {
  ...
  /** return a wining board without the last move, placing X on 0x0 cause a win of X*/
  function getWinningBoard() {
    return [['O', 'O', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O'],
            ['O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X'],
            ['X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O'],
            ['O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X'],
            ['X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O'],
            ...
            ['X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O'],
            ['O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X'],
            ['X', 'X', 'X', 'X', 'X', 'O', 'O', 'O', 'O', 'O', 'X', 'X', 'X', 'X', 'X', '', 'O', 'O', 'O']];
  }
  ...
  it("placing O in 18x0 from initial state is ilegal cause O should not move first", 
    function () {
    expectIllegalMove(1, {},
      [{setTurn: {turnIndex : 0}},
        {set: {key: 'board', value: getBoard([
          {pos: [18, 0], piece: 'O'}])}},
        {set: {key: 'delta', value: {row: 18, col: 0}}},
        {set: {key: 'gameData', value: {totalMove: 1, winner: '', moveIndex: 3}}}]);
  });
  ...
  it("getPossibleMoves returns two cells before X move on the about to tie board", function () {
    var board = getTyingBoard();
    board[0][1] = '';
    var gameData = {totalMove: 359, winner: '', moveIndex: 0};
    var B4tieBoard = angular.copy(board);
    var B4tieBoard2 = angular.copy(board);
    B4tieBoard[0][0] = 'X';
    B4tieBoard2[0][1] = 'X';
    ...
    var expectedMove = [[{setTurn: {turnIndex: 0}},
            ...
            {set: {key: 'delta', value: {row: 0, col: 0}}},
            {set: {key: 'gameData', value: {totalMove: 360, winner: '', moveIndex: 1}}}],
        [{setTurn: {turnIndex: 0}},
                {set: {key: 'board', value: B4tieBoard2}},
                {set: {key: 'delta', value: {row: 0, col: 1}}},
                {set: {key: 'gameData', value: {totalMove: 360, winner: '', moveIndex: 1}}}]
        ];
    expect(angular.equals(possibleMoves, expectedMove)).toBe(true);
  ...
  it("X wins by placing the last cells in wining board", function () {
    var B4winingBoard = getWinningBoard();
    var winningBoard = angular.copy(B4winingBoard);
    winningBoard[18][15] = 'X'; // placing X on 18x15 leads to X win
    expectMoveOk(0,
      {board: B4winingBoard,
        delta: {row: 0, col: 1},
        gameData: {totalMove: 360, winner: '', moveIndex: 1}},
      [{endMatch: {endMatchScores: [1, 0]}},
        {set: {key: 'board', value: winningBoard}},
        {set: {key: 'delta', value: {row: 18, col: 15}}},
