...
(function (gameLogic) {
    ...
    gameLogic.getInitialGameData = getInitialGameData;
    ...
    function getDifferentMoves(board, turnIndexBeforeMove, delta, gameData) {
        ...
        while (true) {
            ...
            for (i = 0; i < n; i++) {
                addMove(row, ++col, board, turnIndexBeforeMove, gameData, winningMoves, threatMoves, possibleMoves, oppTwoThreeMoves, twoThreeMoves);
            }
            if (++m === max) {
                break;
            }
    ...
    gameLogic.getDifferentMoves = getDifferentMoves;
    ...
    function addMove(row, col, board, turnIndexBeforeMove, gameData, winningMoves, threatMoves, possibleMoves, oppTwoThreeMoves, twoThreeMoves) {
